...
// `fallback.path` is the page's own path ("/about"). It becomes the canonical
// link and og:url, resolved against metadataBase in the root layout, so a
// page reached with tracking parameters, or through the bare domain, still
// points search engines at the one real address.
